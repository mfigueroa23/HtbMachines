...
# Funcion para buscar maquinas por certification y sistema operativo
serachMachineByCertificationAndOperatingSystem() {
  certification=$1
  operatingSystem=$2
  if [ $certification -eq 1 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eCPPTv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eCPPTv2' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 2 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eCPTXv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eCPTXv2' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 3 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eJPT${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eJPT' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 4 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eWPT${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eWPT' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 5 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eWPTXv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eWPTXv2' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 6 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSCP${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSCP' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 7 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSWE${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSWE' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 8 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSEP${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSEP' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 9 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSED${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSED' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 10 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}Active Directory${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'Active Directory' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 11 ] && [ $operatingSystem -eq 1 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Linux${endColour} ${grayColour}para la certification${endColour} ${yellowColour}Buffer Overflow${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'Buffer Overflow' -B 7 | grep 'so: "Linux"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 1 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eCPPTv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eCPPTv2' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 2 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eCPTXv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eCPTXv2' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 3 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eJPT${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eJPT' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 4 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eWPT${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eWPT' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 5 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}eWPTXv2${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'eWPTXv2' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 6 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSCP${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSCP' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 7 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSWE${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSWE' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 8 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSEP${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSEP' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 9 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}OSED${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'OSED' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 10 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}Active Directory${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'Active Directory' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  elif [ $certification -eq 11 ] && [ $operatingSystem -eq 2 ]; then
    echo -e "\n${greenColour}[+]${endColour} ${grayColour}Buscando maquinas${endColour} ${yellowColour}Windows${endColour} ${grayColour}para la certification${endColour} ${yellowColour}Buffer Overflow${endColour}\n"
    cat bundle.js | grep 'like:' -B 7 | grep 'Buffer Overflow' -B 7 | grep 'so: "Windows"' -B 4 | grep 'name:' | awk 'NF {print $NF}' | tr -d '",' | column
    echo ""
  else
    echo -e "\n${redColour}[!] Opcion invalida.${endColour} ${grayColour}Los argumentos aceptados son:${endColour}\n"
    echo -e "\t${greenColour}1${endColour}${grayColour}:${endColour} ${yellowColour}eCPPTv2${endColour}"
    echo -e "\t${greenColour}2${endColour}${grayColour}:${endColour} ${yellowColour}eCPTXv2${endColour}"
    echo -e "\t${greenColour}3${endColour}${grayColour}:${endColour} ${yellowColour}eJPT${endColour}"
    echo -e "\t${greenColour}4${endColour}${grayColour}:${endColour} ${yellowColour}eWPT${endColour}"
...
declare -i parameter_certification=0
...
while getopts "m:ui:y:d:s:c:k:h" arg; do
  ...
  d)
    difficulty=$OPTARG
    parameter_difficulty=1
    let parameter_counter+=5
    ;;
  s)
    operatingSystem=$OPTARG
    parameter_operatingSystem=1
    let parameter_counter+=6
    ;;
  c)
    certification=$OPTARG
    parameter_certification=1
...
elif [ $parameter_certification -eq 1 ] && [ $parameter_operatingSystem -eq 1 ]; then
  serachMachineByCertificationAndOperatingSystem $certification $operatingSystem
else
  helpPanel
fi
